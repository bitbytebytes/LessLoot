...
const container_script_path = "res://mods/LessLoot/LootContainer.gd"
var container_script: Script
const simulation_script_path = "res://mods/LessLoot/LootSimulation.gd"
